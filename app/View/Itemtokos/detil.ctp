...
<div class="row">
	...
	<div class="col-md-6">
		...
		echo $this->Form->create('Itemtoko', array('action'=>'edit', 'enctype' => 'multipart/form-data','readonly'=>'readonly'));
		...
		echo $this->Form->input('toko_id', array('type' => 'hidden','class'=>'input-tambah-toko_id','value'=>$data['Itemtoko']['toko_id'],'readonly'=>'readonly'));
