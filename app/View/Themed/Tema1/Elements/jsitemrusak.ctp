<?php
if (strtolower($this->params['controller']) === 'itemtokorusaks') {    
?>
...
<?php } ?>
    ...
    function ajaxitem(){ 
        ...
        $.ajax({
            ...
            datas.forEach(function(data){
                temp+='<tr><td class="hide hasil-id">'+data['Itemtoko']['id']+'</td><td class="hasil-kodebarang">'+data['Item']['kodebarang']+'</td><td class="hasil-nama">'+data['Item']['nama']+'</td><td class="hasil-kodebarang">'+data['Itemtoko']['quantity']+'</td></tr>';
            });
    ...
    $( document ).on( "click", "tr", function() {        
        $('.input-tambah-itemtoko_id').val($(this).children().html());
