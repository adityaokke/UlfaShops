 ...
 */
	Configure::write('Security.salt', 'DYhG93b0q111Ixfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '72259309657453542496749683645');
...
// Configure::write('Session', array(
//     'defaults' => 'php',
//     'timeout' => 20160,            // auto logout after 30 minutes    
...
Configure::write('Session', array(
    ...
    'ini' => array(
        'session.gc_maxlifetime' => 1209600 // 2 weeks
    )
));
