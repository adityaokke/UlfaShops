...
// -----------------------------------------------------------
	...
	public function add() {
		...
		$datas=$this->Unit->find('all',array('recursive'=>-1));
		...
		if ($this->request->is('post')) {
			...
			$temp_item=$this->Itemtoko->find('first',array('recursive'=>0,'conditions'=>array('Item.kodebarang'=>$this->request->data['Itemtoko']['kodebarang'])));
