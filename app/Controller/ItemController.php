<?php
	...
	{	
		...
		public $components = array('Paginator','ImageCropResize.Image');
...

		{
...

			{
...

				{
					...
					$file['name']=$this->request->data['Item']['kodebarang']." ".$this->request->data['Item']['nama'].".".substr(strrchr(strtolower($file['name']),'.'),1);
		...
		private function __upload($file){
			$options = array(
				'width'				=> 500,	//Width of the new Image, Default is Original Width
				'height'			=> 500,	//Height of the new Image, Default is Original Height
			...
			$pathDestination=APP.DS.'files'.DS.'photos'. DS . 'Items'. DS;
			debug($options);
			$this->Image->resize($file['tmp_name'],$file['name'],$pathDestination, $options);
			return true;			
		}
